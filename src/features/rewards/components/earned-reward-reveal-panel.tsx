...
function EarnedRewardRevealPanelContent({
  ...
  return (
    <>
      ...
      >
        <div className="earned-reward-panel-screen">
          ...
          {(phase === "revealing" || phase === "revealed") && imagePath ? (
            ...
            >
              <div className="reward-reveal-portrait-frame">
                <Image
          ...
          {phase === "timed-out" ? (
            <p className="reward-loader-copy">
              Hatching is taking longer than expected. We&apos;ll reveal your reward automatically once
              ready.
            </p>
          ) : null}
        ...
        >
          <div className="jp-modal-aura jp-modal-aura-reveal">
            ...
            >
              ...
              <div className="reward-modal-portrait-frame">
                <Image
                  alt={`${dinosaurName} reward image`}
